...
const RIESGOS_DATA = {
  ...
  definicion: {
    ...
    info: "Dominio que incluye los procesos para planificar la gestión de riesgos, identificar, analizar, planificar respuestas e implementar y monitorear la respuesta a los riesgos del proyecto."
  },
  puntosClave: [
    "Proceso: Planificar → Identificar → Analizar → Responder → Monitorear",
    "Respuestas a AMENAZAS: Evitar, Transferir, Mitigar, Aceptar",
    "Respuestas a OPORTUNIDADES: Explotar, Compartir, Mejorar, Aceptar",
    "Riesgo General del Proyecto: incertidumbre que afecta el resultado total",
    ...
    <div style={{ minHeight: "100vh", background: BG_PAGE, color: "#fff", fontFamily: "system-ui, sans-serif" }}>
      ...
      <div style={{ padding: "32px 48px", maxWidth: "1000px", margin: "0 auto", opacity: visible ? 1 : 0, transform: visible ? "translateY(0)" : "translateY(15px)", transition: "all 0.5s ease" }}>
        ...
        <div style={{ fontSize: "13px", color: GREEN_ACCENT, marginBottom: "25px", }}>
          ...
          <span style={{ color: "#fff", fontWeight: 600}}>{RIESGOS_DATA.titulo}</span>
        </div>
        ...
        <div style={{ background: BG_CARD, border: `1.5px solid ${BORDER_CARD}`, borderRadius: "20px", padding: "35px", marginBottom: "30px", boxShadow: "0 4px 20px rgba(0,0,0,0.2)" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
            <div>
              <div style={{ color: GREEN_ACCENT, fontSize: "13px", fontWeight: 600, marginBottom: "4px" }}>Dominio 6</div>
        ...
        >
          ...
          {activeTab === "Definición" && (
            <div>
              <h3 style={{ color: GREEN_ACCENT, fontSize: "12px", textTransform: "uppercase", letterSpacing: "1px", marginBottom: "15px" }}>{RIESGOS_DATA.definicion.subtitulo}</h3>
              <p style={{ fontSize: "18px", lineHeight: "1.8", color: "#ecfdf5", margin: 0 }}>{RIESGOS_DATA.definicion.info}</p>
            </div>
          )}
          ...
          {activeTab === "Puntos Clave" && (
            <div>
              ...
              <ul style={{ padding: 0, margin: "0 0 30px 0", listStyle: "none" }}>
                {RIESGOS_DATA.puntosClave.map((punto, i) => (
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: "10px" }}>
                {RIESGOS_DATA.areasEnfoque.map((area, i) => (
          ...
          {activeTab === "Tip" && (
            <div style={{ borderLeft: `4px solid ${GREEN_ACCENT}`, paddingLeft: "25px" }}>
              <h3 style={{ color: GREEN_ACCENT, fontSize: "12px", textTransform: "uppercase", letterSpacing: "1px", marginBottom: "10px" }}>{RIESGOS_DATA.tip.subtitulo}</h3>
              <p style={{ fontSize: "17px", lineHeight: "1.7", color: "#d1fae5", fontStyle: "italic", margin: 0 }}>
                "{RIESGOS_DATA.tip.info}"
              </p>
            </div>
          )}
        </div>
