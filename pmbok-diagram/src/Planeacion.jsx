...
// --- DATA STRUCTURE FOR "PLANEACIÓN" ---
const PLANEACION_DATA = {
  id: "02 - 05",
  titulo: "Planeación",
  subtitulo: "Planning Focus Area",
  descripcion: "Definir el cómo, cuándo y con qué. Establecer el curso de acción para alcanzar los objetivos estratégicos y del proyecto.",
  definicion: "Área de enfoque que establece el curso de acción para alcanzar los objetivos del proyecto. Define qué se hará, cómo, cuándo, con qué recursos y cuánto costará.",
  puntosClave: [
    "Plan de Gestión del Proyecto: documento integrado que gobierna la ejecución.",
    "EDT/WBS: descomposición jerárquica del alcance en paquetes de trabajo.",
    "Cronograma: secuencia, duración, recursos y fechas de actividades.",
    "Presupuesto: estimación de costos y línea base financiera.",
  ...
  tip: {
    ...
    info: "La planeación NO termina al inicio. En proyectos adaptativos e híbridos, el plan evoluciona continuamente a lo largo del ciclo de vida."
  }
};
...
export default function DetallePlaneacion() {
    ...
    <div style={{ minHeight: "100vh", background: BG_PAGE, color: "#fff", fontFamily: "system-ui, sans-serif" }}>
      ...
      <div style={{ padding: "32px 48px", maxWidth: "1000px", margin: "0 auto", opacity: visible ? 1 : 0, transform: visible ? "translateY(0)" : "translateY(15px)", transition: "all 0.5s ease" }}>
        ...
        <div style={{ fontSize: "13px", color: PURPLE_ACCENT, marginBottom: "25px", fontWeight: 600 }}>
          ...
          <span style={{ color: "#fff" }}>{PLANEACION_DATA.titulo}</span>
        </div>
        ...
        >
          ...
          {activeTab === "Definición" && (
            <div>
              ...
              <p style={{ fontSize: "17px", lineHeight: "1.8", color: "#f3e8ff", margin: 0 }}>{PLANEACION_DATA.definicion}</p>
            </div>
          )}
          ...
          {activeTab === "Puntos Clave" && (
            <div>
              ...
              <ul style={{ padding: 0, margin: 0, listStyle: "none" }}>
                {PLANEACION_DATA.puntosClave.map((punto, i) => (
          ...
          {activeTab === "Procesos" && (
            <div>
              <h3 style={{ color: PURPLE_ACCENT, fontSize: "12px", textTransform: "uppercase", letterSpacing: "1px", marginBottom: "15px" }}>{PLANEACION_DATA.procesos.subtitulo}</h3>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px" }}>
                {PLANEACION_DATA.procesos.items.map((item, i) => (
          ...
          {activeTab === "Tip" && (
            <div style={{ borderLeft: `4px solid ${PURPLE_ACCENT}`, paddingLeft: "25px", background: "rgba(192, 132, 252, 0.05)", padding: "20px 25px", borderRadius: "0 12px 12px 0" }}>
              <h3 style={{ color: PURPLE_ACCENT, fontSize: "12px", textTransform: "uppercase", letterSpacing: "1px", marginBottom: "10px" }}>{PLANEACION_DATA.tip.subtitulo}</h3>
              <p style={{ fontSize: "16px", lineHeight: "1.7", color: "#e9d5ff", fontStyle: "italic", margin: 0 }}>
                "{PLANEACION_DATA.tip.info}"
              </p>
            </div>
          )}
        </div>
